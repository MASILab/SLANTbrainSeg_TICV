function orig_inv_seg_file = postproc_pipeline_win(target_fname,final_out_dir,in,testing_T1_root_dir,mdir)
...
if strcmp(stage,'naive') || strcmp(stage,'semisuper') || strcmp(stage,'firstroundfusion') || strcmp(stage,'secondroundfinetune')
    for pi = 1:length(pieces)
        ...
        deep_seg_dir = [working_ft_dir filesep piece filesep out_key filesep 'seg_output'];
