...
SubFolders = '/media/ethanyue/Yue/201910-202110academic/SLANT/container1/nss/out/post/FinalResult/';
sub0 = GetFileNames(SubFolders,'*.nii.gz'); 
sub = sub0{1};
almost_nii = load_untouch_nii_gz(strcat('/media/ethanyue/Yue/201910-202110academic/SLANT/container1/nss/out/post/FinalResult/',sub));
almost_img = almost_nii.img;
almost_img1=almost_img;

almost_img1 = logical(almost_img1);

almost_img1 = bwlpropfiltn(almost_img1,'Area',1);

almost_img = almost_img1.*almost_img;
final_img = almost_img;
final_nii = almost_nii;
final_nii.img = final_img;
save_untouch_nii_gz(final_nii,strcat('/media/ethanyue/Yue/201910-202110academic/SLANT/container1/nss/out/post/FinalResult/',sub));
tprintf('Postprocessing Done');
tprintf('\n');